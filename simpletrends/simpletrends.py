...
class SimpleTrends(object): 
	...
	def all_recent_posts_for_tag(self, **kwargs):
		...
		burst_iter = 0
		while next_:
			recent_posts,next_ = params.instagram_api.tag_recent_media_crawl_tag(count=params.batch_size, tag_name=tag_name, pagination_format='next_min_tag_id',max_tag_id=next_, scope='public_content')
